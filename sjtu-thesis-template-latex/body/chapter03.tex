...
另外我们注意到，BPP实际是一种特殊的Petri网，在\cite{Esparza1997}中定义了这种PN的子类，称为Communication Free Petri网，它其实就是一种进程间通信的并发模型。利用这一等价模型，我们可以利用PN中的技术和结论，通过条件的加强，来证明BPP上相关问题的结论。
