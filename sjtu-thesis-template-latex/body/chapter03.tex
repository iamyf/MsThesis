...
而对与nBPP，在\cite{CzerwiAski2011}，中，给出了$\beq$的可判定性结论，而相关的$\beq_{REG}$问题却一直未被解决。而由于下文中将要提到的引理\ref{lemma:semi-dec}，我们可知该问题至少是半可判定的，所以引起包括本文作者在内的许多研究人员的极大兴趣。但是要完全的解决该问题，还需要客服许多技术上的难题。这一问题还将在本文的第\ref{chap:future}中的未解决问题中进一步讨论。
